...
def run_experiment(conn, params):
    """Run one complete experiment using ground_truth_100 (100 test cases)."""
    ...
    for test in TESTS:
        ...
        composite = 0.5 * sc_recall + 0.5 * anc_recall
        by_cat[test["cat"]].append(composite)
